...
<li> <a href="video.html"> <i class="fa fa-youtube"></i>Video </a> </li>
    ...
    <ul class="nav__list">
      <li>
        ...
        <label for="group-1" class="active2"><i class="fa fa-book"></i><span class="fa fa-angle-right"></span>My Courses </label>
        <ul class="group-list">
...
Achievment</div>
                        ...
                        <div class="fl-left">
                        <div class="user-id">Instructions</div>
                        <div class="colone">:</div>
 ...
 <div class="pull-right" style="margin-top: 10px;"><a href="test1.html" class="default-btn"><i class="fa fa-pencil-square-o"></i> Start Test</a></div> 
